...
import {
  ...
  // Define a function to fetch HTML content
  export async function getHTML() {
	...
	// Loop through courses and fetch their images
	  ...
	  <body> <!-- Start of HTML body -->
		...
		<header class="header-banner">
		  <div class="container-width">
			...
			<nav class="menu">
			  <div class="menu-item">Editor</div>
			  <div class="menu-item">Courses</div>
			  <div class="menu-item">Home</div>
			</nav>
			<div class="clearfix"></div>
			<div class="lead-title">Welcome to Our E-Learning Platform</div>
			<div class="sub-lead-title">Start your learning journey today!</div>
			<div class="lead-btn">Enroll Now</div>
		  </div>
		</header>
		...
		<section class="flex-sect">
		  <div class="container-width">
			<div class="flex-title">Available Courses</div>
			<div class="flex-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget condimentum tortor. Nulla facilisi.</div>
			<div class="cards">
			  <!-- Course Cards -->
			  ${courses
				.slice(1) // Skip the first course (if any)
				.map(
				  (course, index) => `
				  <div class="card">
					<img src='${course_image[index]}' alt="course" loading="lazy" class="card-header" />
					<div class="card-body">
					  <div class="card-title">${course.fullname}</div>
					  <div class="card-desc">${purify(course.summary)}</div>
					</div>
				  </div>
				`
				)
		...
		<section class="am-sect">
		  <div class="container-width">
			<div class="am-container">
			  <img src=${phone_app} loading="lazy" class="img-phone" />
		...
		<div class="container-width">
		  ...
		  <div class="badges">
			<div class="badge">
			  ...
			  <img src=${team1} class="badge-avatar"/>
			...
			<div class="badge">
			  ...
			  <img src=${team2} class="badge-avatar"/>
			  <div class="badge-body">
			...
			<div class="badge">
			  ...
			  <img src=${team3} class="badge-avatar"/>
			  <div class="badge-body">
...
// Define a function to fetch CSS content
