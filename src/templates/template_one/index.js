...
import team1 from '$lib/images/team1.jpg';
import team2 from '$lib/images/team2.jpg';
import team3 from '$lib/images/team3.jpg';
import phone_app from '$lib/images/phone-app.png';
	...
	for (const course of courses) {
		if (course.id !== 1) {
			...
			if (imageData.courses[0].overviewfiles.length > 0) {
				...
				course_image.push(temp);
			} else {
				course_image.push('none');
			}
		}
	}
